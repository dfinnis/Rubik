...
// 1. symetry table
// 48 symmetries including reflections.
// 48 symmetries are generated by four "basic" symmetries:
...
// 2. lookup table == prune table == IDA* heuristic
// 2187 (3^7) permutations
//	seperate phase 1 (G0) / phase 2 (G1) tables
